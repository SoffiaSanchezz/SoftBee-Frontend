  ...
  class _RegisterPageState extends State<RegisterPage> {
    ...
    Future<void> registrarUsuario() async {
      final url = Uri.parse("https://softbee-back-end.onrender.com/api/users");
    ...
    bool _esMunicipio(String palabra) {
      final municipios = [
        'cota', 'facatativa', 'mosquera', 'funza', 'madrid', 'zipaquira', 
        'chia', 'cajica', 'tenjo', 'tabio', 'sopo', 'cucuta', 'medellin'
      ];
